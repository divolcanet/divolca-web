...
export const SpatialFull = () => {
  ...
  return (
    <div className=" relative font-mono border border-muted bg-accent-50 overflow-hidden">
      ...
      <div className="absolute top-4 right-4">
        <Tabs value={tab} onValueChange={setTab}>
          <TabsList className=" mx-auto flex-col rounded-2xl md:flex-row md:rounded-full bg-accent ">
      ...
      <Link
        ...
        className={cn(
          ...
          "absolute bottom-4 right-4 bg-accent-100 text-white hover:text-black",
        )}
      >
