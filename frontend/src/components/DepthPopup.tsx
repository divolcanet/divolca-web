    ...
    >
      <div className="bg-volcanic-900/95 backdrop-blur-sm border border-volcanic-600 rounded-lg shadow-xl p-4 w-64 pointer-events-auto">
        <div className="flex items-start justify-between mb-3">
          <div>
            <h4 className="font-oswald text-lg font-semibold text-magma-400">
              {slice.label}
            </h4>
        ...
        <div className="space-y-2">
          <div className="rounded overflow-hidden border border-volcanic-700">
            <div className="h-20 bg-linear-to-br from-lava-600/30 via-lava-500/20 to-volcanic-800 flex items-center justify-center">
          ...
          <div className="rounded overflow-hidden border border-volcanic-700">
            <div className="h-20 bg-linear-to-br from-blue-600/30 via-blue-500/20 to-volcanic-800 flex items-center justify-center">
              <div className="text-center">
