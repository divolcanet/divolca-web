...
function Tabs({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Root>) {
  return <TabsPrimitive.Root data-slot="tabs" data-orientation="horizontal" className={cn("group/tabs flex flex-col gap-2 rounded-full ", className)} {...props} />;
}

const tabsListVariants = cva("group/tabs-list inline-flex w-fit items-center justify-center bg-white dark:bg-black rounded-full p-2", {
